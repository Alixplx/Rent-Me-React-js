        ...
        <div className="md:px-8 py-6 xl:py-8 m-1 sm:m-3 h-[97vh] overflow-y-scroll lg:w-11/12 bg-white shadow rounded-xl">
            ...
            <div className="grid grid-cols-2 gap-4">
                ...
                <div className="flexStart gap-7 p-5 bg-primaryOne lg:min-w-56 rounded-xl">
                    ...
                    <img src={assets.carBlack} className="hidden sm:flex w-8" />
                    <div>
            ...
            <div className="mt-4">
                ...
                <div>
                    ...
                    {dashboardData.bookings.map((booking, index) => (
                        ...
                        <div key={index} className="flex justify-between items-center flex-wrap gap-2 sm:grid grid-cols-[2fr_2fr_1fr_1fr] lg:grid-cols-[0.5fr_2fr_2fr_1fr_1fr] px-6 py-3 bg-primary text-gray-50 text-sm font-semibold border-b-1 border-slate-900/10">
                            ...
                            <div className="flexStart gap-x-2 max-w-64">
                                ...
                                <div className="overflow-hidden rounded-lg">
                                    ...
                                    <img src={booking.car.images[0]} alt={booking.title} className="w-16 rounded-lg" />
                                </div>
                            ...
                            <button className={`${booking.isPaid ? "bg-green-500/80 text-white" : "bg-red-500/80 text-white"} w-22 py-0.5 rounded-full text-xs border border-green-500/30`}>
